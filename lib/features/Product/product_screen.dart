              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    if (state is ProductLoadingState) const Center(child: CircularProgressIndicator()),
                            ...
                            (index) {
                              return DataRow(
                                cells: [
                                  ...
                                  DataCell(Text(_products[index]['price'].toString())),
                                  DataCell(
                                    TextLink(
                                      text: 'View Image',
                                      onPressed: () {
                                        showDialog(
                                          context: context,
                                          builder: (context) => CustomAlertDialog(
                                            content: Image.network(_products[index]['image_url']),
                                            title: 'product image',
                                          ),
                                        );
                                      },
                                  ...
                                  DataCell(Text(_products[index]['stock'].toString())),
